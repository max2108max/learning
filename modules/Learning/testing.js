...
// let obj3 = {
//     _b: 2, // Начальное значение текущего b
//     _prevB: null, // Начальное значение предыдущего b
//     set b(value) {
//         this._prevB = this._b; // Сохраняем предыдущее значение
//         this._b = value;       // Обновляем текущее значение
//     },
//     get b() {
